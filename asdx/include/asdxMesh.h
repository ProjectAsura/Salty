...
public:
    ...
    {
        asdx::FLOAT3    Diffuse;        //!< 拡散反射成分です.
        asdx::FLOAT     Alpha;          //!< 透過度です.
        asdx::FLOAT3    Specular;       //!< 鏡面反射成分です.
    ...
    struct Subset
    {
        asdx::UINT      IndexOffset;    //!< インデックスオフセットです.
        asdx::UINT      IndexCount;     //!< インデックスカウントです.
        asdx::UINT      MaterialID;     //!< マテリアル番号です.
    };
