...
//      フレーム遷移時の処理です.
//---------------------------------------------------------------------------------------
void SaltyApp::OnFrameMove( double time, double elapsedTime )
{
    // ビュー行列を更新.
    m_TransformParam.View = m_Camera.GetView();
}
...
//      描画時の処理です.
//---------------------------------------------------------------------------------------
void SaltyApp::OnFrameRender( double time, double elapsedTime )
{
...
//      リサイズイベントの処理です.
//---------------------------------------------------------------------------------------
void SaltyApp::OnResize( const asdx::ResizeEventParam& param )
{
    // 射影行列を更新.
...
//      キーイベントの処理です.
//---------------------------------------------------------------------------------------
void SaltyApp::OnKey( const asdx::KeyEventParam& param )
{
    // カメラ処理.
...
//      マウスインベント時の処理です.
//---------------------------------------------------------------------------------------
void SaltyApp::OnMouse( const asdx::MouseEventParam& param )
{
    // カメラ処理.
    m_Camera.OnMouse( 
        param.X,
