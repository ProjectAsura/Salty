...
//---------------------------------------------------------------------------
s3d::BoundingBox CreateMergedBox( s3d::IShape** ppShapes, const u32 numShapes )
{
...
bool SahSplit( std::vector<s3d::IShape*> shapes, s32& bestIndex, s32& bestAxis )
{
    ...
    auto boxRoot = CreateMergedBox(&shapes[0], u32(shapes.size()));
